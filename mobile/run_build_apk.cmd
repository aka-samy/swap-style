...
set "API_BASE_URL_OVERRIDE=%~1"
if "%API_BASE_URL_OVERRIDE%"=="" set "API_BASE_URL_OVERRIDE=%API_BASE_URL%"
...
if "%API_BASE_URL_OVERRIDE%"=="" (
	echo API_BASE_URL: using app default >> C:\swapstyle\mobile\build_apk.log
	...
	echo API_BASE_URL: %API_BASE_URL_OVERRIDE% >> C:\swapstyle\mobile\build_apk.log
	dart.exe --packages="C:\flutter\packages\flutter_tools\.dart_tool\package_config.json" "C:\flutter\packages\flutter_tools\bin\flutter_tools.dart" build apk --debug --dart-define=API_BASE_URL=%API_BASE_URL_OVERRIDE% >> C:\swapstyle\mobile\build_apk.log 2>&1
)
